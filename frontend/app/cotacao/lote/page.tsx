...
import { batchQuotesApi, api, API_URL } from '@/lib/api'
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
          ...
          {inputMethod === 'file' && (
            <div>
              {/* Botao para baixar template */}
              <div className="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-medium text-blue-800 dark:text-blue-200">Baixar template</p>
                    <p className="text-sm text-blue-600 dark:text-blue-400">Use nosso modelo para preencher os produtos</p>
                  </div>
                  <a
                    href={`${API_URL}/api/batch-quotes/template/download`}
                    download
